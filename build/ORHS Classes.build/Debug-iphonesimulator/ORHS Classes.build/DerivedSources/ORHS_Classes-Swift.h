...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ORHS_Classes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12ORHS_Classes20AddYearTableViewCell")
@interface AddYearTableViewCell : UITableViewCell
...
SWIFT_CLASS("_TtC12ORHS_Classes26AddYearTableViewController")
@interface AddYearTableViewController : UITableViewController
- (void)viewDidLoad;
...
- (IBAction)cancelSaveClass:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC12ORHS_Classes21AllClubsTableViewCell")
@interface AllClubsTableViewCell : UITableViewCell
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12ORHS_Classes11AppDelegate")
...
SWIFT_CLASS("_TtC12ORHS_Classes22ChecklistTableViewCell")
@interface ChecklistTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified completionLabel;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12ORHS_Classes5Class")
...
SWIFT_CLASS("_TtC12ORHS_Classes25ClassDetailViewController")
...
- (void)didReceiveMemoryWarning;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (IBAction)unwindToVC1WithSender:(UIStoryboardSegue * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12ORHS_Classes18ClassTableViewCell")
...
SWIFT_CLASS("_TtC12ORHS_Classes24ClassTableViewController")
...
SWIFT_CLASS("_TtC12ORHS_Classes4Club")
@interface Club : NSObject <NSCoding>
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC12ORHS_Classes25ClubDetailsViewController")
@interface ClubDetailsViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified meetingDays;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified meetingTimes;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified website;
...
SWIFT_CLASS("_TtC12ORHS_Classes25CurrentClubsTableViewCell")
@interface CurrentClubsTableViewCell : UITableViewCell
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12ORHS_Classes31CurrentClubsTableViewController")
@interface CurrentClubsTableViewController : UITableViewController
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified goingBack;
- (IBAction)goingBack:(UIBarButtonItem * _Nonnull)sender;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidLoad;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC12ORHS_Classes21ScheduleTableViewCell")
...
SWIFT_CLASS("_TtC12ORHS_Classes27ScheduleTableViewController")
...
SWIFT_CLASS("_TtC12ORHS_Classes17YearTableViewCell")
...
SWIFT_CLASS("_TtC12ORHS_Classes23YearTableViewController")
